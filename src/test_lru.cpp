...
using LRUMapList =
    lpq::LRU<TKey, TValue, std::map<TKey, TValue>, std::list<TKey>>;

template <typename TKey, typename TValue>
using LRUMapVector =
    lpq::LRU<TKey, TValue, std::map<TKey, TValue>, std::vector<TKey>>;

template <typename TKey, typename TValue>
using LRUHashList =
    lpq::LRU<TKey, TValue, std::unordered_map<TKey, TValue>, std::list<TKey>>;

template <typename TKey, typename TValue>
using LRUHashVector =
    lpq::LRU<TKey, TValue, std::unordered_map<TKey, TValue>, std::vector<TKey>>;
...
int main() {
    for (auto sigma : sigmas) {
        auto v1 = GenerateVector(VECTOR_SIZE, sigma);
